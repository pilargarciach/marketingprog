...
Ahora nuestro próximo paso consiste en configurar la matriz término-documento como una red bipartita para lo cual se necesita usar la librería `igraph` [@Csardi2024]
...
El muestreo de folletos promocionales de maestría de marketing provino de la descarga de estos documentos desde la página web de 
