...
Un segundo modelo implica contrastar la hipótesis según la cual las escasas conexiones que observamos en el modelo anterior ocurren debido a un conjunto limitado de habilidades que resultan "más atractivas" para la formación profesional de los estudiantes que se matriculan en las maestrías de marketing. Para probar esta hipótesis, debemos añadir un término adicional en el modelo que incluya al conjunto de habilidades de nuestra red bipartita y observar cuáles de ellas cuentan con un estimado positivo y estadísticamente significativo. 
